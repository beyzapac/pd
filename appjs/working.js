...
function checkfunctionsmultiple() {
    ...
    var btnCoz = document.getElementById('matrixCozumBtn');
    ...
    {
        opval.disabled = true;
        btnCoz.disabled = true;
        document.getElementById('mmatrixerror').innerHTML = "<center>Matris büyüklükleri için lütfen pozitif sayı girişi yapın</center>";
        removeall('generatedmatrix1');
        removeall('generatedmatrix2');
    }
        ...
        if (r1 == r2 && c1 == c2) {
            if (c1 != r2) {
                ...
                document.getElementById('mmatrixerror').innerHTML = "<center>Çarpma işlemi bu girişteki büyüklüklere uygun yapılamaz</center>";
            } else if (c1 == r2) {
                addop('opval', '×');
                opval.disabled = false;
                btnCoz.disabled = false;
            }
            ...
            addop('opval', 'Bu girişler ile işlem yapılamaz');
            removeall('generatedmatrix1');
            removeall('generatedmatrix2');
        }
